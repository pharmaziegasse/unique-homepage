                        ...
                        <div className="modal-dialog modal-full-height modal-bottom" role="document">
                            <div className="modal-content">
                                <div className="modal-body">
                                    <p>Wir verwenden Cookies, damit unsere Website für Sie optimal funktioniert. Mit der Nutzung der Website erklären Sie sich einverstanden, dass PHARMAZIEGASSE<sup>®</sup> Cookies verwendet.<br/><a href="https://www.pharmaziegasse.at/?p=Privacy" target="_blank" rel="noopener noreferrer">Mehr über Cookies</a></p>
